...
This is all open source but I would like you to give credit when using anything that is in this repo. Check out the [Attribution-NonCommercial-ShareAlike 4.0 International license](LISCENCE.txt) or click here:
